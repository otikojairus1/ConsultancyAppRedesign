import { View, Text ,Dimensions,Image,KeyboardAvoidingView,TextInput,Keyboard,TouchableWithoutFeedback, StyleSheet,ScrollView} from 'react-native'
    ...
    let rendered = messages.map((message)=>{
        ...
        if(message.sender !== 'jairus'){
            ...
            return(
                ...
                <View style={{marginLeft:70}}>
                     <Text style={{fontSize: 13, color:'green'}}> sent at 11:00pm</Text>
                     </View>
           </View>
            );
