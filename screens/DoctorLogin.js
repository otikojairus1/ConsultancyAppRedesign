  ...
  setTimeout(function(){
    ...
    if(res.data.error != null){
      ...
      navigation.navigate('Dashboard',
       ...
       'account':res.data.userDetails.account,
...
if(loading){
  return(
    ...
    <Text style={{fontSize: 20, textAlign:"center", fontWeight:'bold', color:'green'}}>Authenticating using provided credentials!</Text>
    </SafeAreaView>
  );
}else if(error){
  return(
